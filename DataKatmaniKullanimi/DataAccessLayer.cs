...
namespace DataKatmaniKullanimi
{
    ...
    public class DataAccessLayer
    {
        ...
        {
            SqlConnection con = new SqlConnection("server=DESKTOP-ADS5CUN\\SQLEXPRESS; database=northwnd; integrated security=true");
            con.Open();
            return con;
        }
        ...
        {
            SqlConnection con = new SqlConnection(string.Format("server=DESKTOP-ADS5CUN\\SQLEXPRESS; database={0}; integrated security=true", dbName));
            con.Open();
            return con;
        }
